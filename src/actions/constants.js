...
export const userConstants = {
    ...
    GET_USER_ORDER_DETAIL_REQUEST:'GET_USER_ORDER_DETAIL_REQUEST',
    GET_USER_ORDER_DETAIL_SUCCESS:'GET_USER_ORDER_DETAIL_SUCCESS',
    GET_USER_ORDER_DETAIL_FAILURE:'GET_USER_ORDER_DETAIL_FAILURE',
}