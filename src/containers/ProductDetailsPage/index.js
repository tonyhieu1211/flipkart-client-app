...
const ProductDetailsPage = (props) => {
    ...
    if(Object.keys(productState.productDetails).length === 0) return null;
    return (
        <Layout>
                    ...
                    <div className="productDescContainer">
                        ...
                        <div className="flexRow">
                            <MaterialButton
                                ...
                                onClick = {
                                    () => {
                                        const {_id,name,price} = productState.productDetails;
                                        const img = productState.productDetails.productPics[0].img;
                ...
                <div>
                    ...
                    <div className="breed">
                        <ul>
                            ...
                            <li><a href="#">{productState.productDetails.name}</a></li>
                        </ul>
                    </div>
                    {/* product description */}
                    <div className="productDetails">
                        <p className="productTitle">{productState.productDetails.name}</p>
                        <div>
                        ...
                        <div className="flexRow priceContainer">
                            <span className="price"><BiRupee />{productState.productDetails.price}</span>
                        ...
                        <div>
                            ...
                            <p style={{ display: 'flex' }}>
                                ...
                                <span style={{
                                    fontSize: '12px',
                                    color: '#212121',
                                }}>{productState.productDetails.description}</span>
                            </p>
                        </div>
                    </div>
